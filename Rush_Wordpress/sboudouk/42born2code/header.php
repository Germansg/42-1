...
<div id="header">
	<a href="<?php echo get_option('home'); ?>">
			<img id="site-logo" src="<?php bloginfo('template_directory'); ?>/images/site-logo.png" alt="<?php bloginfo('name'); ?>" />
		</a>
   		<div class="nav">
    		<div class="container">
     			<ul class="pull-right">
<?php 
	if(!is_user_logged_in())
		echo "<a href='", wp_registration_url(), "'> S'enregistrer</a>";
		wp_loginout();
?>
					<li><a href="#">Publiez votre annonce</a></li>
				  </ul>
			  </div>
	  </div>
  </div>
